...
def save_house_info():
    ...
    room_count = house_data.get("room_count")  # 房屋包含的房价数目
    ...
    max_days = house_data.get("max_days")  # 最大入驻天数

    # 校验参数
    if not all([title, price, area_id, room_count, acreage, unit, capacity, beds, deposit, max_days, min_days]):
